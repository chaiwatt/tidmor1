                        ...
                        <div class="content-block">
                            ...
                            <div class="content-block__body">
                                ...
                                <div>
                                    ...
                                    <ul class="content-block__topic-list">
                                        <li>ระบบร่างกายมนุษย์: ครอบคลุมระบบย่อยอาหาร สารอาหาร วิตามิน, ระบบขับถ่าย, การรักษาดุลยภาพ, ระบบหมุนเวียนเลือดและระบบหายใจ, ระบบประสาทและระบบกล้ามเนื้อ, และการเจริญเติบโต</li>
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="content-block">
                            ...
                            <div class="content-block__body">
                                <div>
                                    ...
                                    <ul class="content-block__topic-list">
                                        <li>หิน, ซากดึกดำบรรพ์ และภัยธรรมชาติ: ครอบคลุมการจำแนกประเภทของหิน, วัฏจักรหิน, การใช้ประโยชน์จากซากดึกดำบรรพ์, และความเข้าใจเกี่ยวกับสาเหตุและการเกิดปรากฏการณ์ทางธรณีวิทยา</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 class="content-block__topic-title">ลมฟ้าอากาศและภูมิอากาศ (25%)</h4>
                                    <ul class="content-block__topic-list">
                                        <li>ปรากฏการณ์ลมฟ้าอากาศ: ครอบคลุมการเกิดเมฆ, หยาดน้ำฟ้า (ฝน, หิมะ, ลูกเห็บ), และหลักการเกิดลมบก ลมทะเล และมรสุม</li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 class="content-block__topic-title">ดาราศาสตร์ (35%)</h4>
                                    <ul class="content-block__topic-list">
                                        <li>ระบบสุริยะและปรากฏการณ์ดาราศาสตร์: ครอบคลุมความเข้าใจองค์ประกอบในระบบสุริยะ, การเปรียบเทียบดาวเคราะห์และดาวฤกษ์, และการอธิบายปรากฏการณ์สำคัญ เช่น สุริยุปราคา, จันทรุปราคา, ข้างขึ้นข้างแรม</li>
                                    </ul>
                                </div>
                                <div>
