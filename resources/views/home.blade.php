            ...
            <div class="container">
                        ...
                        <div class="content-block">
                            ...
                            <div class="content-block__body">
                                 <div>
                                    ...
                                    <ul class="content-block__topic-list">
                                        <li>โครงสร้างและหน้าที่: ครอบคลุมองค์ประกอบของสิ่งมีชีวิต ออแกเนลล์พื้นฐานที่สำคัญ เช่น นิวเคลียส, ไมโทคอนเดรีย, ไรโบโซม, เยื่อหุ้มเซลล์, คลอโรพลาสต์, ความแตกต่างของเซลล์พืชและสัตว์ และการลำเลียงสารผ่านเซลล์</li>
                                    </ul>
                                </div>
                                <div>
                ...
                <section class="pricing-section">
                    ...
                    {{-- <div class="pricing-card">
                        ...
                        <div class="qr-code-wrapper">
                            <img src="https://placehold.co/200x200/111827/ffffff?text=QR+CODE" alt="QR Code สำหรับสั่งซื้อทางไลน์" class="qr-code-image">
                            <p class="qr-code-text">สั่งซื้อทางไลน์</p>
                        </div>
