        ...
        <script type="application/ld+json">
        {
            ...
            "itemListElement": [
                ...
                "item": {
                    "@type": "Article",
                    "url": "https://www.yourwebsite.com/article-detail.html",
                    "headline": "รีวิวหนังสือ \"ข้อสอบเข้า ม.1 วิทยาศาสตร์ 3,000 ข้อ\" ใช้จริงแล้วเป็นอย่างไร?",
        ...
        <main class="main-content">
            <div class="container">
                <div class="article-list">
                    ...
                    <!-- Article 5 -->
                    <article class="article-card">
                        <h2 class="article-card__title"><a href="{{route('detail',['slug' => 'ชื่อบทความ'])}}">รีวิวหนังสือ "ข้อสอบเข้า ม.1 วิทยาศาสตร์ 3,000 ข้อ" ใช้จริงแล้วเป็นอย่างไร?</a></h2>
